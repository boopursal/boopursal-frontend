...
function Renouvellement(props) {
  ...
  const abonnement = useSelector(
    ({ renouvellementAbonnementApp }) => renouvellementAbonnementApp.abonnement
  );
            ...
            <div className="flex flex-1 w-full items-center justify-between">
                  ...
                  <div className="flex flex-col min-w-0">
                    ...
                    >
                      <div className="text-16 sm:text-20 truncate">
                        {"Renouvellement d'abonnement, Fournisseur : " +
              ...
              >
                ...
                <DialogContent className="mb-12">
                  {!paiement
                    ? "Voullez-vous vraiment valider l'abonnement sans confirmation du paiment?"
                    : "Vous êtes sur le point d'affecter un nouveau abonnement"}
                </DialogContent>
                <Divider />
                <DialogActions>
                  <Button
