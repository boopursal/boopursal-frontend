                                        ...
                                        <Button size="small" variant="contained" color="default"
                                            ...
                                            onClick={(ev) => {
                                                ...
                                                dispatch(Actions.openDialog({
                                                    children: (
                                                        <React.Fragment>
                                                            <DialogTitle id="alert-dialog-title">Nouveau Acheteur / Master</DialogTitle>
                                                            <DialogContent>
                                                                <DialogContentText id="alert-dialog-description">
                                                                    Vous êtes en train d'ajouter une nouveau Acheteur / Master,
                                                                </DialogContentText>
                                                            </DialogContent>
                                                            <DialogActions>
                                                                <Button onClick={() => dispatch(Actions.closeDialog())} variant="outlined" color="secondary">
                                                                    Annuler
                                                                </Button>
                                                                <Button
                                                                    onClick={(ev) => {
                        ...
                        /* {
                            ...
                            Cell: row => (
                                <div className="flex items-center">
                                    ...
                                    <Tooltip title="Ajouter comme un nouveau acheteur" >
 ...
 */
                    ...
                    defaultPageSize={10}
                    noDataText="Aucune d'essai de s'inscrire trouvée"
                    loading={loading}
