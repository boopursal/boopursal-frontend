...
const useStyles = makeStyles((theme) => ({
  ...
  fiche: {
    ...
    backgroundImage:
      "url(https://source.unsplash.com/collection/9631824/1600x900)",
        ...
        <Grid item sm={8} xs={12}>
          ...
          >
            <div
              className={clsx(
                classes.fiche,
                "rounded-t-md relative max-w-2xl mx-auto"
              )}
              style={{
                backgroundImage:
                  activites.secteur &&
                  activites.secteur.image &&
                  "url(" + URL_SITE + activites.secteur.image.url + ")",
              }}
            >
              <div className={clsx(classes.divTitle)}>
                <Typography
                  className={clsx(
                    classes.shadow,
                    "uppercase  text-28 font-bold text-white tracking-wide "
                  )}
                  component="h1"
                  color="primary"
                >
