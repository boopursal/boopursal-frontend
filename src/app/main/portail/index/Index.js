        ...
        <Container maxWidth="lg" style={{ position: 'relative', zIndex: 2 }}>
          <FuseAnimate animation="transition.slideUpIn" duration={800}>
            <div>
              ...
              <h1 className={classes.heroTitle} dangerouslySetInnerHTML={{ __html: t('portail.heroTitle', 'Acheteur & Fournisseurs: connectez-vous <br/> aux <span style="color: #274b99;">bonnes opportunités</span>') }} />
            </div>
          </FuseAnimate>
