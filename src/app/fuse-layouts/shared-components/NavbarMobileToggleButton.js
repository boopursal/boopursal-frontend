...
function NavbarMobileToggleButton(props)
{
    ...
    const handleToggle = () => {
        if (isMobile) {
            dispatch(Actions.navbarToggleMobile());
        } else {
    ...
    return (
        <button 
           className={clsx("items-center justify-center w-10 h-10 text-gray-500 border-gray-200 rounded-lg z-99999 dark:border-gray-800 flex dark:text-gray-400 lg:h-11 lg:w-11 xl:border", props.className)} 
